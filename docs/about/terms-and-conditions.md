...
1. **“API” -** the application programming interface (including any SDKs, keys and documentation) that we make available for the purpose of integrating the Integration Solution functionalities into Your Platform.
   ...
   9. _Net Partner Fee = Partner Fee−Infrastructure Fee_
...
3. **YOUR OBLIGATIONS**
   ...
   3. Transparency\*\*.\*\* You must:
      ...
      2. clearly display _“Powered by Aurora labs”_, or similar wording as provided from time to time by Aurora, to the End User prior to the End User submitting an Order through the Integration Solution(s) on the Partner’s Platform; and

...
* Enable AI agents to perform any operation on chain
...
If you want a frontend-first integration, the [Intents Connect Widget ](../intents-connect-widget/introduction.md)may be a better starting point.

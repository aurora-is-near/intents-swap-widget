...
import {
  tokenSetDefault,
  type TokenSetDefaultPayload,
} from './tokenSetDefault';
...
import {
  pollingTransactionsSet,
  type PollingTransactionsSetPayload,
} from './pollingTransactionsSet';
...
export type TradeEvents = {
  ...
  pollingTransactionsSet: PollingTransactionsSetPayload;
};
...
export const registerEvents = () => {
  ...
  onEvent('tokenSetDefault', tokenSetDefault);
